...
async function migrate() {
  ...
  await pool.query(`
    ...
    ALTER TABLE ivr_settings ADD COLUMN IF NOT EXISTS after_hours_sms_message TEXT    DEFAULT 'Thanks for your message! Our team is away right now, but we''ll reply as soon as we''re back during business hours.';
